...
$(function() {
	...
	$("#next").click(function(){
		pageNo = pageNo+1;
		/* $("form:first").submit(); */
		window.location.href = "${path}/Teacher/listTeacher.do?pageNo="+pageNo;
	})
	...
	$("#fir").click(function(){
		 /* $("form:first").submit();  */
		window.location.href = "${path}/Teacher/listTeacher.do?pageNo="+1;
	});
	
	$("#last").click(function(){
		
		/* $("form:first").submit(); */
		window.location.href = "${path}/Teacher/listTeacher.do?pageNo="+totalPage;	
	})
	...
	$("#jump").click(function(){
		...
		if(!reg.test(selectPageNo)){
			...
			if(selectPageNoNum < 1 || selectPageNoNum > totalPage){
				...
				/* $("form:first").submit(); */
				window.location.href = "${path}/Teacher/listTeacher.do?pageNo="+selectPageNo;
			};
