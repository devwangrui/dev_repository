...
<body class="nav-md">
							...
							<form action="" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12" style="">
										<div class="rowBox container form-control col-md-7 col-xs-12"
											...
											<!-- <div class="rowBox_add col-md-12 col-sm-12 col-xs-12" id="addrow_box"
												style="margin-top: 0px;display:none" data-toggle="modal" data-target="#myModal" title="点击设置此内容"
												>
												<div style="" class="blp" id="">
													<p>十</p>
													--&nbsp;点击此区域添加横向分区&nbsp;--
								...
								<div class="form-group">
									...
									<input type="button" class="btn btn-primary col-md-offset-4" value="返回"
										onclick="window.location.href='${path}/YzTargetSort1/configChart.do?id=${pid }&sort=${sort}'" />
    ...
    $('#page_submit').click(function(){
    	...
    	var is_show=1;
    	var sort=${sort};
        $.post('${path }/YzTargetSort1/savePage.do ',{is_show:is_show,pid:pid,controller:controller, charts:charts,title:title}, function(data){
        	if(data=="SUCCESS"){
       		 
       		 var r=confirm("数据提交成功!是否跳转到页面管理层......");
       		 if (r==true)
       		   {
       			 window.location.href='${path}/YzTargetSort1/configChart.do?id='+pid+'&sort='+sort;
       		   }
       	};
