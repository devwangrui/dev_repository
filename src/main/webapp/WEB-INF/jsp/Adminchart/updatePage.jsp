        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>页面配置 <small>当前位置/页面配置</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content"> <br />
                            <form action="" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="button" class="btn btn-primary col-md-offset-4" value="返回" onclick="window.location.href='${path}/YzTargetSort1/configChart.do?id=${pid }&sort=${sort}'"/>
...
<script src="https://cdn.bootcss.com/popper.js/1.14.3/esm/popper.min.js"></script> 
    ...
    $('#page_submit').click(function () {
        ...
        var is_show = 1;
      	var sort=${sort};
        $.post('${path }/YzTargetSort1/addUpdate.do', {
            id: id,
            pid: pid,
            title: title,
            is_show: is_show,
        		 ...
        		 if (r==true)
        		   {
        			 ...
        			 window.location.href="${path}/YzTargetSort1/updatePage.do?id="+pid+"&sort="+sort;
        		   };
