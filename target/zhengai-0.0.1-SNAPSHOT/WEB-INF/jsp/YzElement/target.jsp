...
<head>
    ...
    <link href="${path}/css/vendors/zTree/css/demo.css" rel="stylesheet">
    <link rel="stylesheet" href="${path}/css/vendors/zTree/css/zTreeStyle/zTreeStyle.css">
    <!-- Custom Theme Style -->
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <button type="button" class="btn btn-primary" onclick="window.location='${path}/YzElement/listYzElement.do?sort=${sort} '">返回</button>
...
<script src="${path}/css/vendors/zTree/js/jquery.ztree.core.min.js"></script>
<script src="${path}/css/vendors/zTree/js/jquery.ztree.excheck.js"></script>
<script src="${path}/css/vendors/zTree/js/jquery.ztree.exedit.js"></script>
        ...
        $(document).ready(function(){
            ...
            $("#save").click(function(){
               ...
               var result="";
                ...
                if(TreeNodes!=null){
                	...
                	if(opt){
                		window.location.href = "${path}/YzElement/configElementTarget.do?id="+id+"&ids="+result+"&sort="+sort;
           ...
           /*  $('#save').click(function(){
                ...
                if(TreeNodes!=null){
                	...
                	if(opt){
                		window.location.href = "${path}/YzElement/configElementTarget.do?id="+id+"&ids1="+ids1+"&ids2="+ids2+"&ids3="+ids3+"&sort=${sort}";
                	}
